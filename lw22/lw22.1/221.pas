...
BEGIN {InsertionSort}
  ...
  DO
        ...
        BEGIN
          ...
          DO
            ...
            THEN
              ...
              END
            ELSE
              Found := TRUE;         {Найти значения Prev и Curr, если существуют такие что
          ...
          THEN
            First := Index
          ELSE
            Arr[Prev].Next := Index;{Включение Arr[Index] в связанный список}
        END
    END; 
    Index := First;
    WHILE Index <> ListEnd
    DO
      ...
      END;
    WRITELN;{Печать списка начиная с Arr[First]}
END.  {InsertionSort}
